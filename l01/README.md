...
[DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Introduction.html) is AWS's fully managed NoSQL database. It is a great fit for serverless applications like the one we'll be building, as there are no VPCs or any other hurdles to leap.
